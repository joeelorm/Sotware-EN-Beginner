...
if (early && age > 18){
  console.log(`You will race at 9:30 with race number of ${raceNumber}`)
} else if (!early && age > 18){
  console.log(`You will race at 11:00 am with a race number of ${raceNumber}`)
} else if (age < 18){
  console.log(`You will race at 12:30 with a race number of ${raceNumber}`)
} else {
